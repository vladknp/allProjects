$(function(){
  ...
  //=====  Forms  =====//
  //
  var recipient = 'rukharisov@yandex.ru'
  ...
  setInterval(function () {
    ...
    // do some time calculations
      ...
      //Только "2" "дня" до "31.12"
      var only_day = ("Только " + days + " " + daypad + " (до " + offer.getDate() + "." + (offer.getMonth()+1) + ")");

      //только до "31.12"
      var only_day_second = ("Только до " + offer.getDate() + "." + offer.getMonth()+1)
    ...
    // format countdown string + set tag value
      ...
      //Вывод текста Только "2" "дня" до "31.12"
      //onlyDayTo.textContent=(pad(only_day));

      //Вывод текста Только до "31.12"
      $(".onlyTo").text(pad(only_day_second));
